...
void scrollimage_setPixel(scrollimage *s, unsigned int x, unsigned int y, unsigned char on);
unsigned char scrollimage_getPixel(scrollimage *s, unsigned int x, unsigned int y);
